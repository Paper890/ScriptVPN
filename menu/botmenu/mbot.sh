...
Name=$(curl https://raw.githubusercontent.com/Paper890/izin/main/permisi | grep $MYIP | awk '{print $2}')
...
botbckpBot_menu() {
	...
	echo -e "               BOT AUTOBACKUP              $NC"
    echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
    echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
    echo -e "  ${green} Status AutoBackup : $sts"
    echo -e ""
    echo -e "  ${ORANGE}1.${NC} \033[0;36m Setup Bot Telegram ${NC}"
    echo -e "  ${ORANGE}2.${NC} \033[0;36m Turn on/off Autobackup ${NC}"
    echo -e "  ${ORANGE}3.${NC} \033[0;36m Backup VPS (Via Telegram Bot) ${NC}"
    echo -e "  ${ORANGE}4.${NC} \033[0;36m Restore Data VPS ${NC}"
    echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
    echo -e "  Enter for back to menu"
    echo -e ""
