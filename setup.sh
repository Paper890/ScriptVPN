...
# <IZIN SCRIPT>
BURIQ () {
    curl -sS https://raw.githubusercontent.com/pontora/autoscript-multiws/main/permission/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/pontora/autoscript-multiws/main/permission/ip | grep $MYIP | awk '{print $2}')
